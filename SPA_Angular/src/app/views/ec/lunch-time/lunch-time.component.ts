import { PeriodMixingModalComponent } from './period-mixing-modal/period-mixing-modal.component';
...
export class LunchTimeComponent implements OnInit {
  ...
  openPeriodModal(data: any) {
    const modalRef = this.modalService.open(PeriodMixingModalComponent, {
      size: "xl",
    });
  ...
  getBuildingByLunchTime(){
    this.lunchTimeService.getBuilingByLunchTime().subscribe(res => {
